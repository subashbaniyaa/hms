...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center mb-5">Welcome! Let's get you started.</h2>
            <div class="row">
                <div class="col-md-6 mx-auto card-holder">
                    <div class="card border-secondary">
                        <div class="card-header bg-dark text-white">
                            <h3 class="mb-0 my-2"><i class="fas fa-user-plus mr-2"></i>Sign Up</h3>
                        </div>
                        <div class="card-body">
                            <form class="form" role="form" autocomplete="off" id="registration-form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <button type="button" id="toggleRegPassword" tabindex="-1"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        <input type="password" class="form-control"
                                               ...
                                               style="padding-right:2.5rem;">
                                        <button type="button" id="toggleRegPassword2" tabindex="-1"
                                                style="position:absolute;right:0.6rem;top:50%;transform:translateY(-50%);background:none;border:none;padding:0;color:#6c757d;line-height:1;">
                                            <i class="fas fa-eye" id="toggleRegPassword2Icon"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="submit" class="btn btn-primary btn-md float-right"
                                            name="registerSubmitBtn" value="Create Account">
                                </div>
                            </form>
                        </div>
                    </div>
...
<script>
    document.getElementById('toggleRegPassword').addEventListener('click', function () {
        var passwordField = document.getElementById('registrationPassword');
        var icon = document.getElementById('toggleRegPasswordIcon');
    ...
    document.getElementById('toggleRegPassword2').addEventListener('click', function () {
        var passwordField = document.getElementById('registrationPassword2');
        var icon = document.getElementById('toggleRegPassword2Icon');
        if (passwordField.type === 'password') {
            passwordField.type = 'text';
            icon.classList.remove('fa-eye');
            icon.classList.add('fa-eye-slash');
